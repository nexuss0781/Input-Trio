...
that train_input_layer reads directly.

Usage:
    pip install datasets huggingface_hub
    python dataset.py          # writes to ../Component-1.2_Token-Embedding/Data/
    python dataset.py --data_dir /path/to/data
"""
...
def main():
    ...
    parser.add_argument("--data_dir", default="../Component-1.2_Token-Embedding/Data",
    ...
    print(f"[dataset.py] Then run: cd master-input && ./build/train_input_layer --data_dir {args.data_dir}")
